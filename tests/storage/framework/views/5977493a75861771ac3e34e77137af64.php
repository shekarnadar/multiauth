...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" name="name" id="name" placeholder="name@example.com" >
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" name="email" id="email" placeholder="name@example.com" >
...
</html><?php /**PATH C:\xampp\htdocs\laravel\resources\views/register.blade.php ENDPATH**/ ?>